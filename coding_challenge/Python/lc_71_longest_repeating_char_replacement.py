def char_replacement(s: str, k: int) -> int:
    ...
    check_appear_count = (
        {}
    )  # this for checking how manytimes a character appear in the string
...
if __name__ == "__main__":
    ...
    assert char_replacement("AAAA", 2) == 4
    assert char_replacement("BAAA", 0) == 3
    assert char_replacement("ABCDEF", 2) == 3
